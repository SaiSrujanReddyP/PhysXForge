...
<center><img width="255" alt="main page" src="physics1.png"></center><br>
...
<center><img width="291" alt="add new object interface" src="physics2.png"></center><br>
...
## add new surface
<center><img width="290" alt="add new surface" src="physics3.png"></center><br>
...
## add new round block
<center><img width="288" alt="add new round block" src="physics4.png"></center><br>
...
## set time values
<img width="287" alt="Set time values" src="physics6.png"><br>
...
<img width="198" alt="information box" src="physics7.png"><br>
<br>
...
<img width="252" alt="main window while simulation is being rendered" src="physics8.png"><br>

## play the simulation
You can play the simulation after it has been rendered.

<img width="374" alt="Simulation window" src="physics9.png"><br>
